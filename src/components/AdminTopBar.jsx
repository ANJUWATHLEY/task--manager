...
const AdminTopBar = () => {
  ...
  return (
    <div className="w-full">
      {/* Top Search Header */}
      <header className="w-full bg-[#2c1c80] py-3 px-6 flex items-center justify-between shadow-md">
        ...
        <form
          ...
          className="flex items-center bg-[#3c2d8f] px-4 py-2 rounded-xl shadow-md w-full max-w-md"
        >
      ...
      {/* Search Results - Show only if input is not empty */}
      {data.trim() && (
